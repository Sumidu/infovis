...
## Interaktivität kann einen Plot informativer machen
...
Mauszeiger über die Punkte bewegen
]
...
## Die Auswahl sollte hervorgehoben werden ...
...
## ... und/oder alle anderen ausgeblendet
...
## Interaktivität mit expliziten Labels kombinieren
...
## Mit weiteren Informationen oder Seiten verlinken
...
.absolute-bottom-right.small-font[
Auf die Bundesstaaten klicken
]

---

## Hervorheben in zwei verschiedenen Plots
...
## Interaktive Plots in R

---
## Mit dem **ggiraph** Paket können wir Plots interaktiv machen
...
.small-font[
**ggiraph** Version:  
Hovern zeigt den Speziesnamen an
]
]

---

## Anpassen geschieht über Cascading Style Sheets (CSS)
...
## Interludium: A Kurzeinführung in CSS

--

CSS ist *die* Sprache zur Gestaltung von Webseiten

--

Es gibt vielen Tutorials online, z.B.: https://www.w3schools.com/css/default.asp

---

## Mehrere Punkt auf einmal auswählen mit der `data_id` Aesthetic
...
Anpassung wieder mit CSS

]

---

## Interaktive Beispielkarte
...
.small-font[
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Klicken um die wikipedia-Seite zu öffnen
]
]
...
- **ggiraph** Dokumentation: [Using **ggiraph**](https://davidgohel.github.io/ggiraph/articles/offcran/using_ggiraph.html)
- **ggiraph** Dokumentation: [Function reference](https://davidgohel.github.io/ggiraph/reference/index.html)
