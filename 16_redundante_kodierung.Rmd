...
## Farbkodierung alleine reicht häufig nicht aus
...
Iris virginica und Iris versicolor sind schwer zu unterscheiden
...
Verschiedene simulierte Farbenblindheiten der selben Abbildung
]
...
## Farben und Formen zu nutzen hilft
...
Die Farbzuordnung wurde auch getauscht
...
## Reihenfolge der Legende beachten
...
Reihenfolge der Legende **passt nicht** zu der visuellen Anordnung der Linien
...
Reihenfolge der Legende **passt** zu der visuellen Anordnung der Linien
...
## Noch besser: Gar keine Legende nutzen
...
Diese Technik heißt "direct labeling"
...
## Direct labeling des Iris Scatterplots
...
## Wenn zu viele Items zu labeln wären, eine Teilmenge labeln
...
Anmerkung: Die default Legende passt nicht zu den Daten
...
## 2. Manuelles labeling mit `geom_text()`
...
Tabelle mit Label-Positionen händisch anlegen:
...
## 3. Automatisches labeling mit `geom_text_repel()`
...
`box.padding` steuert wie weit die Labels ovn den Daten platziert werden
---

## Weitere Literatur

- Fundamentals of Data Visualization: [Kapitel 20: Redundant coding](https://clauswilke.com/dataviz/redundant-coding.html)
