...
# Verwendung von Farbe in Visualisierung
...
1. Kategorien unterscheiden (qualitativ)
</td>
<td>
...
2. Numerische Werte abbilden (sequentiell)
</td>
<td>
...
<tr style = "background: white;">
<td style = "text-align: left;">
3. Numerische Werte abbilden (divergierend)
</td>
<td>
...
## **ggplot2** color scale Funktionen sind unsystematisch :(
...
## Das **colorspace** Paket bringt etwas Ordnung rein
...
.small-font[
- `<aesthetic>`: Name der Aesthetic (`fill`, `color`, `colour`)
- `<datatype>`: Typ der angezeigten Variable (`discrete`, `continuous`, `binned`)
- `<colorscale>`: Typ der Farbskala (`qualitative`, `sequential`, `diverging`, `divergingx`)
]
...
## Diskrete, qualitative Skalen setzt man am besten manuell
...
- Fundamentals of Data Visualization: [Kapitel 4: Color scales](https://clauswilke.com/dataviz/color-basics.html)
- Fundamentals of Data Visualization: [Abbildung 19.10: Okabe-Ito color palette](https://clauswilke.com/dataviz/color-pitfalls.html#fig:palette-Okabe-Ito)
